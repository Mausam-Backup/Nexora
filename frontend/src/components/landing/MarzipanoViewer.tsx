...
import { SCENES, getSceneById } from '@/data/tour/scenes';
import { LOCATION_META, getAllLocations } from '@/data/tour/locations';
import { SceneData, LocationMeta, LinkHotspot, InfoHotspot } from '@/types/tour';
